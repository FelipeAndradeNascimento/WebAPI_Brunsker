...
namespace Adm_Imoveis.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdPessoa,Nome,Email,Telefone,IdTipo")] Pessoas pessoas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPessoa,Nome,Email,Telefone,IdTipo")] Pessoas pessoas)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Context_db.Pessoas'  is null.");
            }
            var pessoas = await _context.Pessoas.FindAsync(id);
            if (pessoas != null)
            {
